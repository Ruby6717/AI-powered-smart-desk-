...
# === Setup ===
known_faces_dir = "enrolled_faces"  # Directory where enrolled faces are stored
...
# === Setup ESP32 Camera Stream URL ===
# Replace with your ESP32 camera IP address and stream path
url = 'http://192.168.1.104:81/stream'  # Change this to your ESP32 camera URL
